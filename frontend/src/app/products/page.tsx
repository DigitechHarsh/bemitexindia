...
const dummyProducts: Product[] = [
  { id: 1, name: "Premium Anarkali Kurti with Embroidery", slug: "premium-anarkali", fabric: "Rayon Slub", moq: 12, price_per_piece: 450, category_name: "Kurtis", main_image: null },
  { id: 2, name: "Georgette Designer Salwar Suit", slug: "georgette-suit", fabric: "Georgette", moq: 6, price_per_piece: 1250, category_name: "Salwar Suits", main_image: null },
  { id: 3, name: "Banarasi Silk Saree Collection", slug: "banarasi-silk", fabric: "Banarasi Silk", moq: 8, price_per_piece: 1850, category_name: "Sarees", main_image: null },
  { id: 4, name: "Cotton Printed Kurti Set", slug: "cotton-kurti-set", fabric: "Pure Cotton", moq: 20, price_per_piece: 350, category_name: "Kurtis", main_image: null },
  { id: 5, name: "Heavy Bridal Gown", slug: "heavy-bridal-gown", fabric: "Net & Satin", moq: 4, price_per_piece: 3500, category_name: "Gowns", main_image: null },
  { id: 6, name: "Pashmina Winter Suit", slug: "pashmina-winter", fabric: "Pashmina", moq: 10, price_per_piece: 850, category_name: "Salwar Suits", main_image: null },
];
